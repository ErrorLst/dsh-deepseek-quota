...
//
// Two read-only HTTP routes on the web profile's webServer:
//
...
const DEFAULT_PRICING = {
  version: "deepseek-v4-2026-08-17",
  currency: "CNY",
  tiers: {
    "deepseek-chat": {
...
function isPeak(timeMs) {
  const minutes = Math.floor(((timeMs + BEIJING_OFFSET_MS) % DAY_MS) / 60_000);
...
export { foldSessionUsage, isPeak, normalizePricing, resolveTier };
